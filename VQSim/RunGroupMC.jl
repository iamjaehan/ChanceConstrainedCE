...
df = run_mc_epoch_test(cfgE; out_csv="mc_epoch_results_7a_20s_50c.csv")

### Test case 10 ### 6 / 15 / 0.75
cfgE.alpha = 0.75
println("Running test case 10")
df = run_mc_epoch_test(cfgE; out_csv="mc_epoch_results_7a_20s_75c.csv")

### Test case 11 ### 6 / 15 / 0.95
cfgE.alpha = 0.95
println("Running test case 11")
df = run_mc_epoch_test(cfgE; out_csv="mc_epoch_results_7a_20s_95c.csv")

### Test case 12 ### 6 / 15 / 0.99
cfgE.alpha = 0.99
println("Running test case 12")
df = run_mc_epoch_test(cfgE; out_csv="mc_epoch_results_7a_20s_99c.csv")

### Test case 13 ### 6 / 15 / 0.99
cfgE.alpha = 0.3
println("Running test case 13")
df = run_mc_epoch_test(cfgE; out_csv="mc_epoch_results_7a_20s_30c.csv")